...
export default function ar({booksales}) {
...
export async function getServerSideProps( ) {
  ...
  const data = await db.collection("states").find({"state":"Arkansas"}).sort({"library":1}).limit(20).toArray();
